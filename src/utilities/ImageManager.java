...
public class ImageManager {
	...
	/*
		Old method that loaded .gifs

		public static Image loadImage(String fname, boolean animated) throws IOException {
			Image img = null;
			if (animated) { img = new ImageIcon(path + fname + ".gif").getImage(); }
			else { img = ImageIO.read(new File(path + fname + ext)); }
			images.put(fname, img);
			return img;
		}
	 */
